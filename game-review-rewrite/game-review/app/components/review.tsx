...
type ReviewProps = ReviewType & {
  readMoreClick: MouseEventHandler<HTMLButtonElement> &
...
export default function Review({
  ...
  return (
    <>
      ...
      >
        <div
          className="flex flex-col w-96 bg-zinc-900 rounded-lg duration-100 transition-transform max-h-96"
          ...
          <div className="flex flex-row">
            ...
            <button
              className={`w-full bg-blue-500 ${
                editMode ? "rounded-br-lg" : "rounded-b-lg"
